...
from api.collections.views import CollectionList,addCollection,deleteCollection,CollectionDetail,CollectionProductList
...
urlpatterns = [
    ...
    path('detail/<slug>/',CollectionProductList.as_view()  ,  name='collection'),
