dial_codes = [
        ...
        {"name":"Mexico","dial_code":"+52","code":"MX"},{"name":"Monaco","dial_code":"+377","code":"MC"},
        ...
        {"name":"Rwanda","dial_code":"+250","code":"RW"},{"name":"Samoa","dial_code":"+685","code":"WS"},
...
print("[")
for county in dial_codes:
    print(f'("{county["dial_code"]}","{county["name"]}"),')
print("]")
